...
//!
//! Every position and colour arrives from `vqa_core::plot::draw`, which the exported
...
use vqa_core::plot::{Canvas, Chrome, Rgba, Scene, TextAlign, draw};
...
impl Canvas for EguiCanvas<'_> {
    fn rect(&mut self, rect: vqa_core::plot::Rect, fill: Rgba) {
